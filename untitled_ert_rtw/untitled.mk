...
## Generated on : Tue Dec 11 05:56:37 2018
...
DEFINES_ = -D_roboticscape_in_use_ -DMODEL=untitled -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DTERMFCN=1 -DONESTEPFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DARM_PROJECT -D_USE_TARGET_UDP_ -D_RUNONTARGETHARDWARE_BUILD_ -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT
...
SRCS = rtGetInf.c rtGetNaN.c rt_nonfinite.c untitled.c untitled_data.c MW_bbblue_init.c linuxinitialize.c
...
OBJS = rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o untitled.c.o untitled_data.c.o MW_bbblue_init.c.o linuxinitialize.c.o
